...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:family "Linux Libertine Mono" :background "grey77"))))
 ...
 '(font-lock-string-face ((t (:foreground "grey20" :family "IBM Plex Mono"))))
 ...
 '(ivy-cursor ((((class color) (background light)) (:foreground "black" :background "black")) (((class color) (background dark)) (:foreground "white" :background "black"))))
 ...
 '(magit-section-highlight ((((class color) (background light)) (:background "grey5" :extend t)) (((class color) (background dark)) (:background "grey44" :extend t))))
 ...
 '(org-done ((t (:inherit org-headline :foreground "black" :background "#0ad" :box t))))
 ...
 '(lsp-rust-analyzer-inlay-face ((t (:inherit font-lock-comment-face :foreground "black" :background "black"))))
